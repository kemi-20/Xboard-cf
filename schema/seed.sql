...
('server_pull_interval', '300', unixepoch(), unixepoch()),
('server_push_interval', '300', unixepoch(), unixepoch()),
...
('resend_from_address', '', unixepoch(), unixepoch()),
('resend_from_name', 'XBoard', unixepoch(), unixepoch()),
