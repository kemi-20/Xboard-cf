...
window.XBOARD_TRANSLATIONS['ru-RU'] = {
  ...
  "server": {
    ...
    "form": {
      ...
      "traffic_limit": {
        "label": "Трафик (ГБ)",
        "placeholder": "0 означает без ограничений",
        "hint": "Лимит трафика узла в ГБ; 0 означает без ограничений",
        "error_numeric": "Лимит трафика должен быть числом",
        "error_gte_zero": "Лимит трафика должен быть не меньше 0"
      },
      "traffic_reset": {
        "label": "Способ сброса трафика",
        "placeholder": "Выберите способ сброса",
